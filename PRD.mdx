...
* Tasks:
    ...
    * 11.4 Migrate Album Management routes: In Progress.
    * 11.5 Migrate Image Management routes: In Progress.
    * 11.6 Migrate Face Management routes: In Progress.
    * 11.7 Replace Joi with TypeBox for validation: Pending.
    * 11.8 Verify all migrated endpoints with tests: Pending.
* Status: In Progress.
